...
?>		
		...
		<hr class="normal" />
		18/03/07 - News postée par TuxP<h4>Pti dèj</h4> 
		<p>N'oublies pas de réserver ton petit dèj pour demain matin !</p>
		<hr class="normal" />
		...
		<p>C'est parti !!! Aujourd'hui la campagne commence et pour cette occasion trés spéciale le yech'ti sort de son antre pour... s'éclater pendant 4 semaines de folies au rythmes des soirées endiablées et petits dèj à domicile !</p>
		<p>Dés ce soir la yech'team te propose un repas tout droit sorti des montagnes ainsi que des glaces ! Profites des dernières heures de sommeil qu'il te reste... </p>
