...
class calendrier extends module {
	...
	var $core;
	var $message;
	var $actions_module = array(	"Toutes nos activit�s"=>"activites",
	...
	function corps()
	{
		...
		{
			echo "<p>Voici le calendrier des �v�nements organis�s cette semaine. Prends bien note !</p><br />	";
		switch ($num_semaine)
		{
		case 11:
...
?>
	<table class="calendrier">
		...
		<tr>
			...
			<td rowspan="2"></td>
			<td rowspan="3"></td>
			<td class="rempli"><a href="?menu=evenements&module=reservation&date_ev=0318">Petit d�j</a></td>
		</tr>
		<tr>
			<td class="titre_ligne">Apr�m</td>
			<td rowspan="2"></td>
		</tr>
		<tr>
...
?>
	...
	<table class="calendrier">
		...
		<tr>
			<td class="titre_ligne">Matin</td>
			<td></td>
			<td class="rempli">Petit d�j � <br />Centrale</td>
			<td rowspan="3"></td>
			<td></td>
			<td class="rempli">Petit d�j � <br />Centrale</td>
			<td rowspan="2"></td>
		...
		<tr>
			<td class="titre_ligne">Apr�m</td>
			<td class="rempli">Gouter � <br />Centrale</td>
			<td rowspan="2"></td>
		...
		<tr>
			...
			<td></td>
			<td></td>
			<td class="rempli"><!--<a href="?menu=evenements&module=reservation&date_ev=0324">-->Torcho solidarit�<br />Sidaction</td>
		</tr>
	</table>
...
?>
	...
	<table class="calendrier">
		...
		<tr>
			...
			<td class="rempli">Soir�e orientale</td>
			<td></td>
		</tr>
		</table>
...
?>			
	<table class="calendrier">
		...
		<tr>
			<td class="titre_ligne">Matin</td>
			<td rowspan="3"></td>
			<td rowspan="3" class="rempli"><strong>D�bat des prez</strong></td>
			<td rowspan="3" class="rempli"><strong>2�me tour</strong></td>
		</tr>
		<tr>
			<td class="titre_ligne">Apr�m</td>
		</tr>
...
<?php		
	...
	elseif ($_GET['action']=='affiches') echo "<p>Ici tu retrouveras toutes nos affiches au fur et � mesure que la campagne avance !</p>";	
	}
	function pied()
	{
	}
