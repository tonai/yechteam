...
class inscription extends module {
	...
	function action()
	{
		if (isset($_GET['action']) && $_GET['action']=='verif')
		{
			...
			elseif(isset($buff)) $this->message="Ce login existe d�j� !";	
	...
	function corps()
	{
		...
		{
			echo "<p>En t'inscrivant tu pourras participer � toutes nos activit�s mais aussi d�couvrir notre section bonus !
	</p><br />";
